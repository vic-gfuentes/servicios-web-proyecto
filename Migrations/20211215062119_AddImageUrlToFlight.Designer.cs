...
namespace servicios_web_proyecto.Migrations
{
    ...
    [Migration("20211215062119_AddImageUrlToFlight")]
    partial class AddImageUrlToFlight
    {
            ...
            modelBuilder.Entity("servicios_web_proyecto.Models.Flight", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            FlightId = "CT-3",
                            Date = new DateTime(2021, 12, 15, 0, 21, 19, 468, DateTimeKind.Local).AddTicks(6296),
